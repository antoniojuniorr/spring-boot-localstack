...
echo ### Criando profile LocalStack...
aws --endpoint http://localhost:4566 configure set aws_access_key_id default_access_key --profile localstack
aws --endpoint http://localhost:4566 configure set aws_secret_access_key default_secret_key --profile localstack
aws --endpoint http://localhost:4566 configure set region us-east-1 --profile localstack
