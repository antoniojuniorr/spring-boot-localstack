package io.github.antoniojuniorr.springbootlocalstack.service;

import com.amazonaws.services.s3.AmazonS3;
import io.awspring.cloud.core.io.s3.PathMatchingSimpleStorageResourcePatternResolver;
import io.github.antoniojuniorr.springbootlocalstack.exception.FileListenerException;
...
public class S3FileService {
    ...
    @Autowired
    public void setupResolver(ApplicationContext applicationContext, AmazonS3 s3) {
        this.resourcePatternResolver = new PathMatchingSimpleStorageResourcePatternResolver(s3,
                applicationContext);
    }
